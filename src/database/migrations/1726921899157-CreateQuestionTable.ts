...
export class CreateQuestionTable1726921899157 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_971de984acb4f35388c89619482" FOREIGN KEY ("status") REFERENCES "status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_624a92566d1b8efe4cde3853c3b" FOREIGN KEY ("subject_id") REFERENCES "subject"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_0dd8a8fdac66faf307336fd699b" FOREIGN KEY ("grade_id") REFERENCES "grade"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_8aa6f8ef7e29e7c070bd2446f7f" FOREIGN KEY ("curriculum_id") REFERENCES "curriculum"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
